				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
											...
											<form method="POST" action="index.php">
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" id="email" name="email" class="form-control" placeholder="Enter college email address">
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" id="rno" name="rno" class="form-control" placeholder="Enter college admission number">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" value="Continue" name="submit" id="sendmail">
													</div>
												</div>
											</form>	
										</div>
						...
						else
						{
							...
							$rnu = $_POST['rno'];
							$sql="SELECT AdmNo FROM `userinfo` WHERE `AdmNo` like '%$rnu%'";
						    // WHERE `AdmNo`=`$rnu` ";
							...
							$_SESSION['voter'] = array($email, $otp, $rnu);
							print_r($_SESSION['voter']);
							...
							$mail->Username = 'tochu786@gmail.com';        // SMTP username
							$mail->Password = 'barmer123';               // SMTP password
							$mail->SetFrom('tochu786@gmail.com', 'SVNIT Voting');
						...
						// // 	// $mail->AddBcc($email3,$name);
							...
							$mail->Body = 'Enter this OTP to register yourself on SVNIT Voting Portal'.$otp;                      //HTML Body 
						...
						?>
						<script>
							alert("OTP sent to <?php print($email); ?>")
						</script>
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
							<div class="form-wrap">
								<div class="tab">
										...
										<div class="tab-content-inner active" data-content="signup">
											...
											<form method="POST" action="verify.php">
												<div class="row form-group">
													<div class="col-md-12">
														<label for="fullname">Your Email</label>
														<input type="text" id="email" name="email" class="form-control" placeholder="<?php print($email); ?>" readonly>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label for="rollno">ROLL NO.</label>
														<input type="text" id="rno" name="rno" class="form-control" placeholder="<?php print($rnu); ?>" readonly>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
