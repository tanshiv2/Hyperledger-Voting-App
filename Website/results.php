...
<!-- 			      <li class="active"><a href="#">Home</a></li>
			      ...
			      <li class="active"><a href="admin.php">AdminV</a></li>
			      <li><a href="adminc.php">AdminC</a></li>
	    		</ul>
  			</div>
		</nav>
        <div class="container">
...
$(document).ready(function(){
	$.get("http://localhost:3000/api/VoteLog/", function(data){
		...
		var candidateList = [];
		var categoryList = [];
		var resultTime = new Date(data[data.length-1].timestamp);
		...
		else
		{
			...
			alert('Intezaar ka phal meetha hota hai')
		}
		// $("#result").html(html);
		// console.log(html);	
	});
